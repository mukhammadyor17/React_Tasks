  ...
  return (
    <div className="fixed bottom-5 right-5 bg-white dark:bg-gray-800 p-4 rounded-lg shadow-xs dark:shadow-gray-900/50 border border-gray-200 dark:border-gray-700 flex flex-col gap-4">
      ...
      <div className="flex gap-5">
        ...
        <button className="px-6 py-2 bg-indigo-500 hover:bg-indigo-600 dark:bg-indigo-600 dark:hover:bg-indigo-700 text-white rounded active:bg-indigo-700 dark:active:bg-indigo-800 transition-colors">
          Download
        </button>
      </div>
    </div>
